...
class FaqsController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        faqData = [FaqCellData(question: "Where can I place stickers?", answer: "For now, our stickers can only be placed on your WhatsApp chat rooms."),
                  ...
                  FaqCellData(question: "How do I use Octo Frames?", answer: "Once you've clicked Octo Frames Try Now you will be able to take a photo or choose a photo to edit from your library. You can edit the images with stickers, fonts & frame then chose to save it and share it on your social feeds.")]
